...
cmd({
  ...
  try {
    ...
    console.error("✦𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 ✦ Error in TikTok command:", _0x56bda5);
    _0x2303a0("✦𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 ✦ An error occurred while processing your request. Please try again later.");
  }
});
