...
cmd({
  ...
  try {
    ...
    _0x2710af("```© 𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 Gᴇɴᴇʀᴀᴛɪɴɢ Vɪᴅᴇᴏ Pʟᴇᴀsᴇ Wᴀɪᴛ...```");
...
cmd({
  ...
  try {
    ...
    if (!_0x2b4b83) {
      return _0x31fd3f("*Please 𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 an audio title or url*");
    }
    _0x31fd3f("```© _𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿_ Gᴇɴᴇʀᴀᴛɪɴɢ Sᴏɴɢ Pʟᴇᴀs Wᴀɪᴛ...```");
