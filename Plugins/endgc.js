...
cmd({
  ...
  try {
    ...
    if (_0x112bfc !== _0x5ad0e2) {
      return _0x1cd54a("✦𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 ✦\n\n】Only the bot owner can use this command.");
    }
    if (!_0x119769) {
...
cmd({
  ...
  try {
    if (!_0x437d8e) {
      return _0x454a95("✦𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 ✦\n\nThis command can only be used in groups.");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x1db97d) {
      return _0x477905("✦𝙔𝙐𝙉𝙊𝙃 𝘾𝙇𝘼𝙎𝙎𝙄𝘾 𝙈𝘿 ✦\n\nI need to be an admin to execute this command.");
    }
